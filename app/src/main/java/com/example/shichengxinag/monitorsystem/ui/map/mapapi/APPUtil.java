package com.example.shichengxinag.monitorsystem.ui.map.mapapi;
...
public class APPUtil {
	...
	public static void startNative_Baidu(Context context,Location loc1,Location loc2){
		...
		try {
//			region=beijing&origin=39.98871,116.43234&destination=40.057406655722,116.2964407172&mode=walking"
//			Intent intent = Intent.getIntent("intent://map/direction?region=beijing&origin="+loc1.getLat()+","+loc1.getLng()+"&destination="+loc2.getLat()+","+loc2.getLng()+"&mode=driving#Intent;scheme=bdapp;package=com.baidu.BaiduMap;end");
			Intent intent = new Intent();
			intent.setData(Uri.parse("baidumap://map/navi?location="+loc2.getLng()+","+loc2.getLat()));
