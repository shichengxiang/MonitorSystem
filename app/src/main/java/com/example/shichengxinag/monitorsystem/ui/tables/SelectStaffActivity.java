...
public class SelectStaffActivity extends BaseActivity {
    ...
    class StaffsAdapter extends RecyclerView.Adapter<StaffsAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.item_stafflist, parent, false);
    ...
    public void onItemSelected() {
        ...
        dialog.setDialogType(PromptDialog.DIALOG_TYPE_SUCCESS)
                ...
                .setTitleText("派发成功")
                .setPositiveListener("完成", new PromptDialog.OnPositiveListener() {
                    @Override
