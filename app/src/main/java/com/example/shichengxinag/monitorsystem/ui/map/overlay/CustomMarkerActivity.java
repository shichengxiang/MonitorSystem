package com.example.shichengxinag.monitorsystem.ui.map.overlay;
...
import com.example.shichengxinag.monitorsystem.ui.map.route.util.Constants;
...
public class CustomMarkerActivity extends Activity implements AMap.OnMarkerClickListener,
	...
	private void addMarkersToMap() {
		...
		markerOption.icon(BitmapDescriptorFactory
				.fromResource(R.mipmap.rightarrow));
