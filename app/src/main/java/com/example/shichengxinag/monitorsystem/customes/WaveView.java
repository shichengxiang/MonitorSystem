package com.example.shichengxinag.monitorsystem.customes;
...
public class WaveView extends View {
    ...
    private static final int DEFAULT_WAVE_COLOR = Color.parseColor("#FF0F64D2");
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Init Progress
        mProgressValue = attributes.getInteger(R.styleable.WaveView_wlv_progressValue, DEFAULT_WAVE_PROGRESS_VALUE);
