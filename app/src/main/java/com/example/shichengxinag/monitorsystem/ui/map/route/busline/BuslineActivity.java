package com.example.shichengxinag.monitorsystem.ui.map.route.busline;
 ...
 * AMapV2地图中简单介绍公交线路搜索
 */
public class BuslineActivity extends Activity implements AMap.OnMarkerClickListener,
		AMap.InfoWindowAdapter, OnItemSelectedListener, OnBusLineSearchListener, OnClickListener {
	private AMap aMap;
